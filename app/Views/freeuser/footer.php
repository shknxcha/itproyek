        ...
        <div class="row g-5">
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="footer-item">
                    ...
                    <p class="text-white">Dolor amet sit justo amet elitr clita ipsum elitr est.Lorem ipsum dolor sit
                        amet, consectetur adipiscing elit. Nullam in tempor dui, non consectetur enim.</p>
            ...
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="footer-item d-flex flex-column">
                    ...
                    <p class="mb-0"><i class="fas fa-map-marker-alt text-secondary me-2"></i> 123 ranking street North
            ...
            <div class="col-md-6 col-lg-6 col-xl-3">
                <div class="footer-item d-flex flex-column">
                    ...
                    <ga href=""><i class="fas fa-angle-right me-2"></i> Twitter</ga>
...
<script src="<?= base_url('sparlex/');?>lib/wow/wow.min.js"></script>
<script src="<?= base_url('sparlex/');?>lib/easing/easing.min.js"></script>
<script src="<?= base_url('sparlex/');?>lib/waypoints/waypoints.min.js"></script>
<script src="<?= base_url('sparlex/');?>lib/counterup/counterup.min.js"></script>
<script src="<?= base_url('sparlex/');?>lib/lightbox/js/lightbox.min.js"></script>
<script src="<?= base_url('sparlex/');?>lib/owlcarousel/owl.carousel.min.js"></script>

<!-- Template Javascript -->
<script src="<?= base_url('sparlex/');?>js/main.js"></script>
</body>
