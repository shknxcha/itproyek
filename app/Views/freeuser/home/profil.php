        ...
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-7">
                <?php foreach ($profile as $row): ?>
                    ...
                    <h1 class="display-4 mb-4"><?= $row['judul'] ?></h1>
                    <p class="mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it.</p>
                    <div class="row g-4">
                        <div class="col-md-6">
                    ...
                    <p class="my-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
